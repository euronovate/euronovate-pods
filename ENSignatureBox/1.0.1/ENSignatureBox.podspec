Pod::Spec.new do |s|
  ...
  s.source = {
    :http => 'https://xcframeworks.s3.eu-south-1.amazonaws.com/ENSignatureBox/1.0.1/ENSignatureBox.xcframework.zip',
    :type => 'zip'
  }
  ...
  s.dependency 'ENBioLibrary', '1.0.1'
  s.dependency 'ENPDFMiddleware', '1.0.1'
