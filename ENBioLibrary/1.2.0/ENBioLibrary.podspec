Pod::Spec.new do |s|
  ...
  s.source = {
    :http => 'https://xcframeworks.s3.eu-south-1.amazonaws.com/ENBioLibrary/1.2.0/ENBioLibrary.xcframework.zip',
    :type => 'zip'
  }
  ...
  s.dependency 'ENBioLibrary_ObjC', '1.2.0'
  s.dependency 'ENMobileSDK', '1.2.0'
