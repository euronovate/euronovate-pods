Pod::Spec.new do |s|
  ...
  s.source = {
    :http => 'https://xcframeworks.s3.eu-south-1.amazonaws.com/ENBioLibrary/' + "1.3.10" + '/ENBioLibrary.zip',
    :type => 'zip'
  }
  ...
  s.dependency 'ENUtils', "1.3.10"
  s.dependency 'ENBioLibraryObjC', "1.3.10"
