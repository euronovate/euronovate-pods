Pod::Spec.new do |s|
  ...
  s.source = {
    :http => 'https://xcframeworks.s3.eu-south-1.amazonaws.com/ENBioLibrary/' + "1.3.5" + '/ENBioLibrary.zip',
    :type => 'zip'
  }
  ...
  s.dependency 'ENBioLibraryObjC', "1.3.5"
  s.dependency 'ENMobileSDK', "1.3.5"
