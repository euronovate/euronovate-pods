Pod::Spec.new do |s|
  ...
  s.source = {
    :http => 'https://xcframeworks.s3.eu-south-1.amazonaws.com/ENBioLibrary/1.1.1/ENBioLibrary.xcframework.zip',
    :type => 'zip'
  }
  ...
  s.dependency 'ENBioLibrary_ObjC', '1.1.1'
  s.dependency 'ENMobileSDK', '1.1.1'
