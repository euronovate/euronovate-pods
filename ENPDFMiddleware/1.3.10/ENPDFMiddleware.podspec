Pod::Spec.new do |s|
    ...
    s.source = {
      :http => 'https://xcframeworks.s3.eu-south-1.amazonaws.com/ENPDFMiddleware/' + "1.3.10" + '/ENPDFMiddleware.zip',
      :type => 'zip'
    }
    ...
    s.dependency 'ENMobileSDK', "1.3.10" 
    s.dependency 'ENSoftServer', "1.3.10"
    s.dependency 'ENPDFProcessor', "1.3.10"
    s.dependency 'ENSignatureBox', "1.3.10"
