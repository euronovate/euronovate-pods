Pod::Spec.new do |s|
  ...
  s.source = {
    :http => 'https://xcframeworks.s3.eu-south-1.amazonaws.com/ENViewer/1.1.90/ENViewer.xcframework.zip',
    :type => 'zip'
  }
  ...
  s.dependency 'ENPresenter', '1.1.90' 
  s.dependency 'ENSignatureBox', '1.1.90'
  s.dependency 'ENPDFMiddleware', '1.1.90'
  s.dependency 'ENSoftServer', '1.1.90'
  s.dependency 'ENUtils', '1.1.90' 
