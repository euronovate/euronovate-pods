Pod::Spec.new do |s|
  ...
  s.source = {
    :http => 'https://xcframeworks.s3.eu-south-1.amazonaws.com/ENViewer/' + "1.3.8" + '/ENViewer.zip',
    :type => 'zip'
  }
  ...
  s.dependency 'ENPDFProcessor', "1.3.8" 
  s.dependency 'ENPresenter', "1.3.8"
  s.dependency 'ENSignatureBox', "1.3.8"
  s.dependency 'ENPDFMiddleware', "1.3.8"
  s.dependency 'ENSoftServer', "1.3.8"
  s.dependency 'ENUtils', "1.3.8"
