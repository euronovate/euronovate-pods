Pod::Spec.new do |s|
  ...
  s.source = {
    :http => 'https://xcframeworks.s3.eu-south-1.amazonaws.com/ENViewer/1.0.0/ENViewer.xcframework.zip',
    :type => 'zip'
  }
  ...
  s.dependency 'ENPDFProcessor', '1.0.0' 
  s.dependency 'ENPresenter', '1.0.0' 
  s.dependency 'ENSignatureBox', '1.0.0' 
