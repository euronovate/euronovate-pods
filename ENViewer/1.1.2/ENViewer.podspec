Pod::Spec.new do |s|
  ...
  s.source = {
    :http => 'https://xcframeworks.s3.eu-south-1.amazonaws.com/ENViewer/1.1.2/ENViewer.xcframework.zip',
    :type => 'zip'
  }
  ...
  s.dependency 'ENPDFProcessor', '1.1.2' 
  s.dependency 'ENPresenter', '1.1.2' 
  s.dependency 'ENSignatureBox', '1.1.2'
  s.dependency 'ENPDFMiddleware', '1.1.2'
  s.dependency 'ENSoftServer', '1.1.2'
