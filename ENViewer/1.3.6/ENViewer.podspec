Pod::Spec.new do |s|
  ...
  s.source = {
    :http => 'https://xcframeworks.s3.eu-south-1.amazonaws.com/ENViewer/' + "1.3.6" + '/ENViewer.zip',
    :type => 'zip'
  }
  ...
  s.dependency 'ENPDFProcessor', "1.3.6" 
  s.dependency 'ENPresenter', "1.3.6"
  s.dependency 'ENSignatureBox', "1.3.6"
  s.dependency 'ENPDFMiddleware', "1.3.6"
  s.dependency 'ENSoftServer', "1.3.6"
  s.dependency 'ENUtils', "1.3.6"
